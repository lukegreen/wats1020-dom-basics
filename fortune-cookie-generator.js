...
var fortunesList = [
  ...
  var randomIndex = Math.floor(Math.random() * (fortunesList.length - 0 + 1) + 0);
  //my randomizer
  
  var randomFortune = fortunesList[randomIndex];
  //selects random fortune
  
  document.getElementById("fortune-cookie-text").innerText = randomFortune;
  //inserts the text in randomFortune into the HTMLAnchorElement
  
  var x = document.getElementById("previous-fortunes-container");
  var y = document.createElement("li");
  x.appendChild(y).innerHTML = randomFortune;
